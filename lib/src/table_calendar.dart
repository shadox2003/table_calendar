...
class _TableCalendarState<T> extends State<TableCalendar<T>> {
  ...
  void _swipeCalendarFormat(SwipeDirection direction, bool cross) {
    if (widget.onFormatChanged != null) {
      ...
      late CalendarFormat format = widget.calendarFormat;
      if (cross) {
        format = widget.calendarFormat == CalendarFormat.week ? CalendarFormat.month : CalendarFormat.week;
      } else {
        if (isSwipeUp) {
          if (widget.calendarFormat == CalendarFormat.month) format = CalendarFormat.week;
        } else {
          if (widget.calendarFormat == CalendarFormat.week) format = CalendarFormat.month;
        }
      }
      ...
      children: [
        ...
        Flexible(
          ...
          child: TableCalendarBase(
            ...
            onGestureController: widget.onGestureController,
